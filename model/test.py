...
def draw_cd_diagram(df_perf=None, alpha=0.05, title=None, labels=False):
    ...
    plt.savefig('D:/cd-diagram.png',bbox_inches='tight')
...
df_perf = pd.read_csv(r'C:\Users\admin\Downloads\cd-diagram-master\example.csv',index_col=False) # 在这里更改要读取的csv的文件位置
