...
minority_class_samples = minority_class_samples[:20]
...
axes[0].scatter(X[random_majority_indices, 0], X[random_majority_indices, 1], color='#8ab1ef', label="Majority", alpha=0.6, s=100)
axes[0].scatter(X[random_minority_indices, 0], X[random_minority_indices, 1], color='#ffcc95', label="Minority", alpha=0.6, s=100)
...
plt.tight_layout()
plt.savefig("fig/selected_samples_and_evidence.jpg")
plt.show()
